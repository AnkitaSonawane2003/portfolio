        ...
        <motion.div className="skills-card" variants={cardVariants}>
          <div className="skills-content">
            ...
            <p className="skills-para">
              I have developed a strong skill set across various programming languages,
              frameworks, and tools that enable me to build efficient and scalable web and mobile
